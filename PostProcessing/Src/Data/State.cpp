...
ID3D11BlendState* gMultiplicativeBlend = nullptr;
...
ID3D11RasterizerState* gWireframeState;
...
bool CreateStates(std::string& LastError)
{
    ...
    {
        LastError = "Error creating Multiplicative state";
        return false;
    }
